...
(photo, full_name, father_name, mother_name, caste, aadhar_number, aapar_id, gender, phone, dob, address, permanent_address, religion, email, parents_mobile,
...
payment_method)
VALUES
('$photo_name', '{$data['full_name']}', '{$data['father_name']}', '{$data['mother_name']}', '{$data['caste']}',
'{$data['aadhar_number']}', '{$data['aapar_id']}',
