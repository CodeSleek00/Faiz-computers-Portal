...
while ($row = $results->fetch_assoc()) {
    ...
    $total_max_marks += ($row['total_questions'] * $row['marks_per_question']);
}
$average_percentage = $total_max_marks > 0 ? round(($total_score / $total_max_marks) * 100, 1) : 0;
$results->data_seek(0);
?>
    ...
    <div class="container">
        ...
        <div class="stats-grid">
            ...
            <div class="stat-card">
                ...
                <div class="stat-number"><?= $average_percentage ?>%</div>
            ...
            <div class="results-list">
                <?php if ($results->num_rows > 0): ?>
                    <?php while ($row = $results->fetch_assoc()): 
                        ...
                        $percentage = $total_marks > 0 ? round(($row['score'] / $total_marks) * 100, 1) : 0;
                        $performance_class = '';
                        
                        if ($percentage >= 80) $performance_class = 'performance-excellent';
                        elseif ($percentage >= 60) $performance_class = 'performance-good';
                        else $performance_class = 'performance-average';
                        
                        $performance_text = '';
                        if ($percentage >= 80) $performance_text = 'Excellent';
                        elseif ($percentage >= 60) $performance_text = 'Good';
                        else $performance_text = 'Average';
                    ?>
                        <div class="result-item">
                            ...
                            <div class="result-body">
                                ...
                                <div class="result-metric">
                                    ...
                                    <div class="metric-value percentage">
                                        <?= $percentage ?>%
                                    </div>
                                </div>
                            ...
                            <div class="result-footer">
                                ...
                                <span>
                                    Submitted: <?= date('h:i A', strtotime($row['submitted_at'])) ?>
                                </span>
                            </div>
                        </div>
                    <?php endwhile; ?>
                <?php else: ?>
                    <div class="empty-state">
                        ...
                        <a href="../../test.php" class="btn" style="width: auto; max-width: 200px; padding: 8px 16px; background: var(--primary); color: white; text-decoration: none; border-radius: var(--radius); font-size: 13px; font-weight: 500;">
