    ...
    if (!isset($_SESSION['authenticated']) || $_SESSION['authenticated'] !== true) {
        ...
        <body>
            <div class="login-container">
                ...
                <p>Enter the password to access the Student Fee Management dashboard.</p>
                <?php if (isset($error)): ?>
    ...
    <div class="container">
        ...
        <div class="header">
            <div style="display: flex; justify-content: space-between; align-items: center;">
                ...
                <a href="?logout=1" class="clear-button" style="background: #ef4444; color: white; border: none; padding: 8px 16px;">Logout</a>
            </div>
        </div>
