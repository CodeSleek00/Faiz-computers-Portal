...
$stmt = $conn->prepare("SELECT id, name, contact, enrollment_id, course, photo FROM students26 WHERE id=? LIMIT 1");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $update = $conn->prepare("UPDATE students26 SET name=?, contact=?, enrollment_id=?, course=?, photo=? WHERE id=?");
