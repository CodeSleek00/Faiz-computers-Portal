...
// Assume student is logged in with enrollment_id
...
<head>
    ...
    <style>
        ...
        .card {
            ...
            border-radius: 14px; box-shadow: 0 5px 10px rgba(0,0,0,0.05);
        }
        .card h3 { margin-top: 0; }
        .meta { color: #777; font-size: 14px; }
        .img-preview { margin-top: 10px; max-width: 300px; }
        .status {
            margin-top: 10px;
            padding: 8px 12px;
        ...
        .marks { font-weight: bold; color: #0056b3; margin-top: 10px; }
        .submit-btn {
